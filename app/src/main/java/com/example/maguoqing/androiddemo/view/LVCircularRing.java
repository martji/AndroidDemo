...
public class LVCircularRing extends View {
    ...
    public LVCircularRing(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.LVCircularRing);
        try {
            ringColor = ta.getColor(R.styleable.LVCircularRing_ring_color, ringColor);
        } finally {
            ta.recycle();
        }
