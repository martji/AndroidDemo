...
public class ChineseCalendarGB {
    ...
    private static ChineseCalendarGB instance = null;

    public static ChineseCalendarGB getInstance() {
        if (instance == null) {
            instance = new ChineseCalendarGB();
        }
        return instance;
    }

    public static String getChineseDay(Calendar day) {
        ChineseCalendarGB c = getInstance();
        c.setGregorian(day.get(Calendar.YEAR), day.get(Calendar.MONTH) + 1, day.get(Calendar.DAY_OF_MONTH));
        c.computeChineseFields();
        c.computeSolarTerms();
        return c.getChineseDay();
    }
    ...
    public String getChineseDay() {
        String result = "";
        result = chineseMonthNames[chineseMonth - 1] + "月" + chineseDayNames[chineseDate - 1];
        return result;
    }
